...
function GameScreen({ session, onLeave, theme, onToggleTheme }) {
  ...
  const exitRoom = () => { socket.emit('leave-room'); clearSession(); onLeave(); };
